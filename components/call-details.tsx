    ...
    <Card>
      <CardContent className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h2 className="text-xl font-semibold mb-4">Información de la llamada</h2>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Badge variant={getOutcomeColor(call.outcome_score)}>{call.outcome}</Badge>
              </div>
            </div>
          </div>

          <div>
            <h2 className="text-xl font-semibold mb-4">Grabación</h2>
            <audio ref={audioRef} src={call.audioUrl} className="hidden" />

            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">{formatDuration(Math.floor(currentTime))}</span>
